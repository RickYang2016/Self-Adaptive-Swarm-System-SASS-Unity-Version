...
public class ImportDecisionLevel : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        changeNumMonsters = newNumMonsters - oldNumMonsters;
        print("Change Times: " + changeNumMonsters);

        // if MonstersList has changed, recalculate the decision
        if(changeNumMonsters != 0)
        {
            RunPythonInCs();
        }
